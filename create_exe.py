...
filesList.append(('', ['cQCLayersMP.so']))
...
filesList.append(('src', ['SaveLoad.py']))
filesList.append(('src', ['QCLayers.py']))
filesList.append(('src', ['Strata.py']))
filesList.append(('src', ['QuantumTab.py']))
filesList.append(('src', ['QuantumTabMatplotlib.py']))
filesList.append(('src', ['EJcanvas.py']))
...
setup(windows=[{"script": "erwinjr.pyw",
      ...
      options={"py2exe": {"skip_archive": True, "includes": [
          "sip", "PyQt4.QtSvg", "matplotlib.backends.backend_qt4agg"]}}
      )
