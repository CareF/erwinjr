...
#===============================================================================
    ...
    def qclPtonLoad(self, fname):
        try:
            ...
            self.qclayers.moleFrac[0]   = float(filehandle.readline().split(':')[1].strip())
            self.qclayers.moleFrac[1]   = float(filehandle.readline().split(':')[1].strip())
            self.qclayers.moleFrac[2]   = float(filehandle.readline().split(':')[1].strip())
            self.qclayers.moleFrac[3]   = float(filehandle.readline().split(':')[1].strip())
